...
class TRPO:
    ...
    def ctrl(self, epi, step, *single_expr):
        ...
        self.replay_memory.push(*[x, u, r, x2, term])
    ...
    def nn_train(self):
        ...
        s_batch, a_batch, r_batch, s2_batch, term_batch = self.replay_memory.sample()

        s_batch = torch.cat(s_batch)
        a_batch = torch.cat(a_batch)
        r_batch = torch.cat(r_batch)
        term_batch = torch.cat(term_batch)
        # ----------------------------
